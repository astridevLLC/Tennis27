...
import yelpIcon from 'src/images/Icons/yelpIcon.svg'
import googleMapsIcon from 'src/images/Icons/googleMapsIcon.svg'
...
function GoogleMapsIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
    return (
        <svg viewBox="0 0 24 24" aria-hidden="true" {...props}>
